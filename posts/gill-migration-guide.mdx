...
#### Before: @solana/web3.js Client Setup
```typescript
...
#### Before: @solana/web3.js Addresses
```typescript
...
#### Before: @solana/web3.js Response
```typescript
const balance = await connection.getBalance(publicKey);
...
#### Before: @solana/web3.js Transactions
```typescript
...
#### Before: @solana/web3.js Keypairs
```typescript
